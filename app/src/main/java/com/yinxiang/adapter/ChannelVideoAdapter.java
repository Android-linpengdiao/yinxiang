...
public class ChannelVideoAdapter extends BaseRecyclerAdapter<HomeVideos.DataBeanX.DataBean, ItemChannelVideoLayoutBinding> {
    ...
    @Override
    protected void onBindItem(final ItemChannelVideoLayoutBinding binding, final HomeVideos.DataBeanX.DataBean dataBean, final int position) {
        if (mList != null && mList.size() > 0) {
