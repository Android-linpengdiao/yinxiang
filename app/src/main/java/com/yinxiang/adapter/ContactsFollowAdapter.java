...
public class ContactsFollowAdapter extends BaseRecyclerAdapter<FollowUserData.DataBeanX.DataBean, ItemContactsLayoutBinding> {
    ...
    public ContactsFollowAdapter(Context context) {
        super(context);
    }
    ...
    @Override
    protected void onBindItem(ItemContactsLayoutBinding binding, final FollowUserData.DataBeanX.DataBean dataBean, final int position) {
