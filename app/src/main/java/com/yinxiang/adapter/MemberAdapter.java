...
public class MemberAdapter extends BaseRecyclerAdapter<String, ItemMemberLayoutBinding> {
    ...
    @Override
    protected void onBindItem(final ItemMemberLayoutBinding binding, final String dataBean, final int position) {
