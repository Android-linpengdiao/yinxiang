...
public class TasksDownLoadListActivity extends AppCompatActivity {

    private static final String TAG = "TasksDownLoadList";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.web_activity_down_load_list);
        ...
        modelList = TasksDownLoadManager.getInstance().getAllTasks();
    ...
    private void registerServiceConnectionListener(final WeakReference<TasksDownLoadListActivity> activityWeakReference) {
        if (listener != null) {
        ...
        private View.OnClickListener taskActionOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (action.equals(v.getResources().getString(R.string.pause))) {
                    ...
                    TasksDownLoadManager.getInstance().addTesk(model.getUrl(), model.getPath(), model.getName());
...
//                    // to delete
                    ...
                    TasksDownLoadManager.getInstance().removeTaskToDB(String.valueOf(holder.id));

                } else if (action.equals(v.getResources().getString(R.string.completed))) {
                    openFile(TasksDownLoadListActivity.this, new File(get(holder.position).getPath()));
        ...
        public TaskItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = getLayoutInflater().inflate(R.layout.web_item_down_load, null);
...
//            Toast.makeText(context, "File corrupted, download again please.", Toast.LENGTH_SHORT).show();
    ...
    public void ShowConfirmDialog(final TasksManagerModel model, final int position) {
        final AlertDialog dialog = new AlertDialog.Builder(TasksDownLoadListActivity.this, AlertDialog.THEME_HOLO_DARK).create();
        dialog.setCancelable(true);
        dialog.show();
        Window window = dialog.getWindow();
        window.getDecorView().setBackgroundColor(Color.parseColor("#00000000"));
        window.setContentView(R.layout.web_view_confirm_dialog_alert);
        ...
        tvRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TasksDownLoadManager.getInstance().removeTaskToDB(String.valueOf(model.getId()));
